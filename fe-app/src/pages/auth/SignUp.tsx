...
const SignUp = () => {
  return (
    <div className="mt-20 flex flex-col justify-center gap-10 max-w-1/2 w-full  mx-auto">
			...
			<p className="text-gray-500 text-left">Already have an account? <Link to="/login" className="text-blue-500 hover:underline">Sign In</Link></p>
			<form action="" className="w-full">
				<Input type="text" id="full_name" name="full_name" placeholder="Full Name*"  className="h-12 md:text-sm" required/>
				<Input type="email" id="email_address" name="email_address" placeholder="Email Address*"  className="mt-4 h-12 md:text-sm" required/>
			...
			<div className="flex justify-between items-center gap-2 w-full">
				...
				<p className="text-gray-500 w-fit">Or register with</p>
				<div className="flex-1 h-0.5 bg-slate-300"></div>
			</div>
